...
class Game:
    def __init__(self,game_close, game_over):
        self.__gameClose = game_close
        self.__gameOver = game_over
    def set_over(self, status):
        self.__gameOver = status
    def set_close(self, status):
        self.__gameClose = status
    def get_over(self):
        return self.__gameOver
    def get_close(self):
        return self.__gameClose
